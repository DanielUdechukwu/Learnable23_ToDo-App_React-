      ...
      <div className="w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%]">
          ...
          {state.tasks.length === 0 ? (
            ...
            <div>
              {state.tasks.map((task, index) => (
                <div
                  className="py-3 px-4 flex items-center border-b-gray-100 font-light"
                  key={index}
                >
        ...
        <div className="input-form">
          ...
          <div className="w-full flex justify-center items-center">
            <button
              className="btn bg-[#32d1ff] hover:bg-[#14e3ff] transition ease-in-out delay-140 w-full py-2 rounded-lg text-sm font-medium"
              type="submit"
